...
REMM is the world's first adaptive AI matchmaking engine built for financial markets. It powers competitive day trading matches on Chart Raiders — the world's first Day Trading E-Sports platform — by dynamically adjusting match parameters to real-time market conditions.
...
*Chart Raiders is the world's first Day Trading E-Sports platform. Players never hold securities. Payouts are determined by player rank — a Game of Skill.*
